...
1. Bundle size is the top priority.
   ...
   - Avoid classes, helper libraries, and utility packages unless the size tradeoff is justified by actual reuse.
...
4. Use efficient code patterns for JS13K.
   ...
   - Do not use JSON parsing or string decoding for game data unless it is smaller after compression than the equivalent raw code.
